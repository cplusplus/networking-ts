...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_waitable_timer(ex, time_point())}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_waitable_timer(ctx.get_executor())}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_waitable_timer(ctx.get_executor(), t)}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_waitable_timer(ctx.get_executor(), d)}.
