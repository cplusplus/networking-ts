...
\tcode{t} denotes a value of type \tcode{Clock::time_point} or \tcode{const Clock::time_point};
and \tcode{d} denotes a value of type \tcode{Clock::duration} or \tcode{const Clock::duration}.
