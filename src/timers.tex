...
\pnum
The \tcode{basic_waitable_timer} template uses wait traits to allow programs to customize \tcode{wait} and \tcode{async_wait} behavior. \begin{note} Possible uses of wait traits include:
\begin{itemize}
\item
