...
\pnum
Several classes defined in this Technical Specification are nested classes. For a specified nested class \tcode{A::B}, an implementation is permitted to define \tcode{A::B} as a synonym for a class with equivalent functionality to class \tcode{A::B}. \enternote When \tcode{A::B} is a synonym for another type \tcode{A} shall provide a nested type \tcode{B}, to emulate the injected class name. \exitnote
