...
\begin{itemize}
\item
\completionsig if the function initiates an asynchronous operation, specifies the call signature~(\CppXref{func.def}) of a completion handler used to receive the result of the operation.
\end{itemize}
