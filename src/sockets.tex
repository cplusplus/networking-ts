...
\begin{itemdescr}
\pnum
\constraints \tcode{is_convertible_v<OtherProtocol, Protocol>} is \tcode{true} and \tcode{is_convertible_v<OtherExecutor, Executor>} is \tcode{true}.
...
\begin{itemdescr}
\pnum
\constraints \tcode{is_convertible_v<OtherProtocol, AcceptableProtocol>} is \tcode{true} and \tcode{is_convertible_v<OtherExecutor, Executor>} is \tcode{true}.
