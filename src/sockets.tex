...
\tcode{errc::bad_file_descriptor} --- if \tcode{is_open()} is \tcode{false}.
\item
\tcode{errc::operation_not_supported} --- current conditions do not permit cancelation. The conditions under which cancelation of asynchronous operations is permitted are implementation-defined.
\end{itemize}
\end{itemdescr}
