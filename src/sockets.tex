...
In the table below, \tcode{E} is a type that satisfies the Executor requirements~(\ref{async.reqmts.executor}).
...
\tcode{X::socket_for<E>}  &
A type that satisfies the requirements of \tcode{Destructible} (\CppXref{destructible}) and \tcode{MoveConstructible} (\CppXref{moveconstructible}), and that is publicly and unambiguously derived from \tcode{basic_socket<X, E>}.  &
  \\
...
\item
an enumerated type, \tcode{shutdown_type}, for use with the \tcode{basic_socket<Protocol, Executor>} class's \tcode{shutdown} member function.
\item
an enumerated type, \tcode{wait_type}, for use with the \tcode{basic_socket<Protocol, Executor>} and \tcode{basic_socket_acceptor<Protocol, Executor>} classes' \tcode{wait} and \tcode{async_wait} member functions,
\item
a bitmask type, \tcode{message_flags}, for use with the \tcode{basic_stream_socket<Protocol, Executor>} class's \tcode{send}, \tcode{async_send}, \tcode{receive}, and \tcode{async_receive} member functions, and the \tcode{basic_datagram_socket<Pro\-t\-o\-col>} class's \tcode{send}, \tcode{async_send}, \tcode{send_to}, \tcode{async_send_to}, \tcode{receive}, \tcode{async_receive}, \tcode{receive_from}, and \tcode{async_receive_from} member functions.
\item
a constant, \tcode{max_listen_connections}, for use with the \tcode{basic_socket_acceptor<Protocol, Executor>} class's \tcode{listen} member function.
\end{itemize}
...
\pnum
Class template \tcode{basic_socket<Protocol, Executor>} is used as the base class for the \tcode{basic_datagram_socket<Pro\-t\-o\-col, Executor>} and \tcode{basic_stream_socket<Protocol, Executor>} class templates. It provides functionality that is common to both types of socket.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket(ctx.get_executor())}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket(ctx.get_executor(), protocol)}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket(ctx.get_executor(), endpoint)}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket(ctx.get_executor(), protocol, native_socket)}.
...
\begin{itemdescr}
\pnum
\effects Move constructs an object of class \tcode{basic_socket<Protocol, Executor>} that refers to the state originally represented by \tcode{rhs}.
...
\begin{itemdescr}
\pnum
\requires \tcode{OtherProtocol} is implicitly convertible to \tcode{Protocol} and \tcode{OtherExecutor} is implicitly convertible to \tcode{Executor}.
...
\pnum
\remarks This constructor shall not participate in overload resolution unless \tcode{OtherProtocol} is implicitly convertible to \tcode{Protocol} and \tcode{OtherExecutor} is implicitly convertible to \tcode{Executor}.
\end{itemdescr}
...
\pnum
\remarks This assignment operator shall not participate in overload resolution unless \tcode{OtherProtocol} is implicitly convertible to \tcode{Protocol} and \tcode{OtherExecutor} is implicitly convertible to \tcode{Executor}.
\end{itemdescr}
...
\pnum
The class template \tcode{basic_datagram_socket<Protocol, Executor>} is used to send and receive discrete messages of fixed maximum length.
...
\pnum
If \tcode{native_handle_type} and \tcode{basic_socket<Protocol, Executor>::native_handle_type}
...
\begin{itemdescr}
\pnum
\effects Initializes the base class with \tcode{basic_socket<Protocol, Executor>(ex)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_datagram_socket(ctx.get_executor())}.
...
\begin{itemdescr}
\pnum
\effects Initializes the base class with \tcode{basic_socket<Protocol, Executor>(ctx, protocol)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_datagram_socket(ctx.get_executor(), protocol)}.
...
\begin{itemdescr}
\pnum
\effects Initializes the base class with \tcode{basic_socket<Protocol, Executor>(ctx, endpoint)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_datagram_socket(ctx.get_executor(), endpoint)}.
...
\begin{itemdescr}
\pnum
\effects Initializes the base class with \tcode{basic_socket<Protocol, Executor>(ctx, protocol, native_socket)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_datagram_socket(ctx.get_executor(), protocol, native_socket)}.
...
\begin{itemdescr}
\pnum
\effects Move constructs an object of class \tcode{basic_datagram_socket<Protocol, Executor>}, initializing the base class with \tcode{basic_socket<Protocol, Executor>(std::move(rhs))}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket<Protocol, Executor>::operator=(std::move(rhs))}.
...
\pnum
\remarks This assignment operator not participate in overload resolution unless \tcode{OtherProtocol} is implicitly convertible to \tcode{Protocol} and \tcode{OtherExecutor} is implicitly convertible to \tcode{Executor}.
\end{itemdescr}
...
\pnum
The class template \tcode{basic_stream_socket<Protocol, Executor>} is used to exchange data with a peer over a sequenced, reliable, bidirectional, connection-mode byte stream.
...
\begin{itemdescr}
\pnum
\effects Initializes the base class with \tcode{basic_socket<Protocol, Executor>(ctx)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_stream_socket(ctx.get_executor())}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_stream_socket(ctx.get_executor(), protocol)}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_stream_socket(ctx.get_executor(), endpoint)}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_stream_socket(ctx.get_executor(), protocol, native_socket)}.
...
\begin{itemdescr}
\pnum
\effects Move constructs an object of class \tcode{basic_stream_socket<Protocol, Executor>}, initializing the base class with \tcode{basic_socket<Protocol, Executor>(std::move(rhs))}.
\end{itemdescr}
...
\pnum
An object of class template \tcode{basic_socket_acceptor<AcceptableProtocol, Executor>} is used to listen for, and queue, incoming socket connections. Socket objects that represent the incoming connections are dequeued by calling \tcode{accept} or \tcode{async_accept}.
...
namespace std::experimental::net::inline @\namespacever@ {
  ...
  public:
    ...
    template<class OtherExecutor>
      socket_type_for<OtherExecutor>
        accept(const OtherExecutor& ex);
    template<class OtherExecutor>
      socket_type_for<OtherExecutor>
        accept(const OtherExecutor& ex, error_code& ec);
    template<class ExecutionContext>
      socket_type_for<typename ExecutionContext::executor_type>
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket_acceptor(ctx.get_executor())}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket_acceptor(ctx.get_executor(), protocol)}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket_acceptor(ctx.get_executor(), endpoint, reuse_addr)}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \tcode{basic_socket_acceptor(ctx.get_executor(), protocol, native_socket)}.
...
\begin{itemdescr}
\pnum
\effects Move constructs an object of class \tcode{basic_socket_acceptor<AcceptableProtocol, Executor>} that refers to the state originally represented by \tcode{rhs}.
...
\begin{itemdescr}
\pnum
\returns \tcode{accept(get_executor(), ec)}.
\end{itemdescr}
...
\pnum
\returns On success, \tcode{socket_type_for<OtherExecutor>(ex, protocol_, h)}. Otherwise \tcode{socket_type_for<OtherExecutor>(ex)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\returns \tcode{accept(ctx.get_executor(), ec)}.
\end{itemdescr}
...
\returns
\begin{codeblock}
async_accept(get_executor(), forward<CompletionToken>(token))
\end{codeblock}
\end{itemdescr}
...
\begin{itemdescr}
\pnum
Let \tcode{S} be the type \tcode{socket_type_for<OtherExecutor>}.

\pnum
\completionsig \tcode{void(error_code ec, S s)}.
...
native_handle_type h = accept(native_handle(), nullptr, 0);
\end{codeblock}
On success, \tcode{s} is \tcode{S(ex, protocol_, h)}. Otherwise,  \tcode{s} is  \tcode{S(ex)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\returns \tcode{accept(get_executor(), endpoint, ec)}.
\end{itemdescr}
...
\pnum
\returns On success, \tcode{socket_type(ex, protocol_, h)}. Otherwise \tcode{socket_type(ex)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\returns \tcode{accept(ctx.get_executor(), endpoint, ec)}.
\end{itemdescr}
...
\returns
\begin{codeblock}
async_accept(get_executor(), endpoint, forward<CompletionToken>(token))
\end{codeblock}
\end{itemdescr}
