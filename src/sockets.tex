...
\pnum
In this document, types that satisfy the \tcode{BooleanSocketOption} requirements are defined as follows.
...
\pnum
In this document, types that satisfy the \tcode{IntegerSocketOption} requirements are defined as follows.
