...
namespace std::experimental::net::inline @\namespacever@ {
  ...
  public:
    ...
    @\addedcode{template<class OtherExecutor>}@
    @\addedcode{using rebind_socket_executor}@
    @\addedcode{  = typename AcceptableProtocol::socket::template rebind_executor<OtherExecutor>::other;}@
    ...
    @\addedcode{template<class OtherExecutor>}@
    @\addedcode{  rebind_socket_executor<OtherExecutor>}@
    @\addedcode{    accept(const OtherExecutor\& ex);}@
    @\addedcode{template<class OtherExecutor>}@
    @\addedcode{  rebind_socket_executor<OtherExecutor>}@
    @\addedcode{    accept(const OtherExecutor\& ex, error_code\& ec);}@
    @\addedcode{template<class ExecutionContext>}@
    @\addedcode{  rebind_socket_executor<typename ExecutionContext::executor_type>}@
...
\begin{itemdescr}
\addedpnum
\added{Let \tcode{S} be the type \tcode{rebind_socket_executor<OtherExecutor>}.}
