...
\added{
\effects Equivalent to: \tcode{return executor_binder<decay_t<T>, Executor>(forward<T>(t), ex)}.
}
...
\begin{itemdescr}
\pnum
\changed{\requires \tcode{Executor} is \tcode{MoveAssignable} (\CppXref{moveassignable}).}{\mandates \tcode{is_move_assignable_v<Executor>} is \tcode{true}.}
