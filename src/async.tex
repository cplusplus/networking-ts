...
\tcode{error_code}  &
\tcode{future<void>}  &
If a$_0$ evaluates to \tcode{true}, atomically stores the exception pointer produced by \tcode{make_exception_ptr(system_error(a$_0$))} in the shared state.  \\ \rowsep

 1  &
\tcode{exception_ptr}  &
\tcode{future<void>}  &
If a$_0$ is non-null, atomically stores the exception pointer a$_0$ in the shared state.  \\ \rowsep
...
\tcode{error_code}  &
\tcode{future<U$_1$>}  &
If a$_0$ evaluates to \tcode{true}, atomically stores the exception pointer produced by \tcode{make_exception_ptr(system_error(a$_0$))} in the shared state; otherwise, atomically stores \tcode{forward<A$_1$>(a$_1$)} in the shared state.  \\ \rowsep

 2  &
\tcode{exception_ptr}  &
\tcode{future<U$_1$>}  &
If a$_0$ is non-null, atomically stores the exception pointer in the shared state; otherwise, atomically stores \tcode{forward<A$_1$>(a$_1$)} in the shared state.  \\ \rowsep
...
If a0 evaluates to \tcode{true}, atomically stores the exception pointer produced by \tcode{make_exception_ptr(system_error(a0))} in the shared state; otherwise, atomically stores \tcode{forward_as_tuple(forward<A1>(a1), ..., forward<A$_{N-1}$>(a$_{N-1}$))} in the shared state.  \\ \rowsep

 >2  &
\tcode{exception_ptr}  &
\tcode{future<tuple<U1,...,U$_{N-1}$>>}  &
If a0 is non-null, atomically stores the exception pointer in the shared state; otherwise, atomically stores \tcode{forward_as_tuple(forward<A1>(a1), ..., forward<A$_{N-1}$>(a$_{N-1}$))} in the shared state.  \\ \rowsep

 >2  &
 all other types  &
\tcode{future<tuple<U0,...,U$_{N-1}$>>}  &
Atomically stores \tcode{forward_as_tuple(forward<A0>(a0), ..., forward<A$_{N-1}$>(a$_{N-1}$))} in the shared state.  \\
