...
Any exception propagated from the \changed{execution of \tcode{\placeholdernc{DECAY_COPY}(forward<Func>(f))()}}{initialization of \tcode{f1} or
\changed{the call}{evaluating}
\tcode{f1()}}
