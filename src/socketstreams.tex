...
\pnum
\constraints
\tcode{is_constructible_v<executor_type, io_context::executor_type>} is \tcode{true}.
...
\pnum
\constraints
\tcode{is_default_constructible_v<basic_socket_streambuf<protocol_type, clock_type, wait_traits_type, executor_type>>} is \tcode{true}.
