...
\begin{itemdescr}
\pnum
\effects Initializes the base class as \tcode{basic_iostream<char>(\&sb_)}, value-initializes \tcode{sb_}, and performs \tcode{setf(std::ios_base::unitbuf)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Initializes the base class as \tcode{basic_iostream<char>(\&sb_)}, initializes \tcode{sb_} with \tcode{std::move(s)}, and performs \tcode{setf(std::ios_base::unitbuf)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Initializes the base class as \tcode{basic_iostream<char>(\&sb_)}, value-initializes \tcode{sb_}, and performs \tcode{setf(std::ios_base::unitbuf)}. Then calls \tcode{rdbuf()->connect(forward<Args>(args)...)}. If that function returns a null pointer, calls \tcode{setstate(failbit)}.
\end{itemdescr}
