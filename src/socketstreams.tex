...
\begin{itemdescr}
\pnum
\effects Calls \tcode{this->close()} then move assigns from \tcode{rhs}. After the move assignment \tcode{*this} and \tcode{rhs} have the observable state they would have had if \tcode{*this} had been move constructed from \tcode{rhs}.
