...
\pnum
Default template arguments are described as appearing both in \tcode{<netfwd>} and in the synopsis of other headers but it is well-formed to include both \tcode{<netfwd>} and one or more of the other headers. \enternote It is the implementation’s responsibility to implement headers so that including \tcode{<netfwd>} and other headers does not violate the rules about multiple occurrences of default arguments. \exitnote
