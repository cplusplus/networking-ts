...
namespace ip {
  ...
  @\removed{constexpr bool operator!=(const address\&, const address\&) noexcept;}@
  @\removed{constexpr bool operator< (const address\&, const address\&) noexcept;}@
  @\removed{constexpr bool operator> (const address\&, const address\&) noexcept;}@
  @\removed{constexpr bool operator<=(const address\&, const address\&) noexcept;}@
  @\removed{constexpr bool operator>=(const address\&, const address\&) noexcept;}@
  @\added{constexpr partial_ordering operator<=>(const address\&, const address\&) noexcept;}@
  ...
  @\removed{constexpr bool operator!=(const address_v4\&, const address_v4\&) noexcept;}@
  @\removed{constexpr bool operator< (const address_v4\&, const address_v4\&) noexcept;}@
  @\removed{constexpr bool operator> (const address_v4\&, const address_v4\&) noexcept;}@
  @\removed{constexpr bool operator<=(const address_v4\&, const address_v4\&) noexcept;}@
  @\removed{constexpr bool operator>=(const address_v4\&, const address_v4\&) noexcept;}@
  @\added{constexpr strong_ordering operator<=>(const address_v4\&, const address_v4\&) noexcept;}@
  ...
  @\removed{constexpr bool operator!=(const address_v6\&, const address_v6\&) noexcept;}@
  @\removed{constexpr bool operator< (const address_v6\&, const address_v6\&) noexcept;}@
  @\removed{constexpr bool operator> (const address_v6\&, const address_v6\&) noexcept;}@
  @\removed{constexpr bool operator<=(const address_v6\&, const address_v6\&) noexcept;}@
  @\removed{constexpr bool operator>=(const address_v6\&, const address_v6\&) noexcept;}@
  @\added{constexpr strong_ordering operator<=>(const address_v6\&, const address_v6\&) noexcept;}@
...
@\added{namespace std::ranges \{}@

  @\added{template<>}@
    @\added{inline constexpr bool}@
      @\added{enable_view<experimental::net::\namespaceverN::ip::address_v4_range> = true;}@
  @\added{template<>}@
    @\added{inline constexpr bool}@
      @\added{enable_borrowed_range<experimental::net::\namespaceverN::ip::address_v6_range> = true;}@

@\added{\}}@

@\added{namespace std::experimental::net::inline \namespaceverN{} \{}@
@\added{namespace ip \{}@
  ...
  @\removed{bool operator!=(const network_v4\&, const network_v4\&) noexcept;}@

  // \ref{internet.network.v6.comparisons}, network_v6 comparisons
  bool operator==(const network_v6&, const network_v6&) noexcept;
  @\removed{bool operator!=(const network_v6\&, const network_v6\&) noexcept;}@
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{bool operator!=(const basic_endpoint<InternetProtocol>\&,}@
                    @\removed{const basic_endpoint<InternetProtocol>\&);}@
  @\removed{template<class InternetProtocol>}@
    @\removed{bool operator< (const basic_endpoint<InternetProtocol>\&,}@
                    @\removed{const basic_endpoint<InternetProtocol>\&);}@
  @\removed{template<class InternetProtocol>}@
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{bool operator>=(const basic_endpoint<InternetProtocol>\&,}@
                    @\removed{const basic_endpoint<InternetProtocol>\&);}@
  @\added{template<class InternetProtocol>}@
    @\added{partial_ordering operator<=>(const basic_endpoint<InternetProtocol>\&,}@
                                 @\added{const basic_endpoint<InternetProtocol>\&);}@
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{bool operator!=(const basic_resolver_entry<InternetProtocol>\&,}@
                    @\removed{const basic_resolver_entry<InternetProtocol>\&);}@
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{bool operator!=(const basic_resolver_results<InternetProtocol>\&,}@
                    @\removed{const basic_resolver_results<InternetProtocol>\&);}@
  ...
  @\removed{bool operator!=(const tcp\& a, const tcp\& b)}@

  class udp;

  // \ref{internet.udp.comparisons}, udp comparisons
  bool operator==(const udp& a, const udp& b);
  @\removed{bool operator!=(const udp\& a, const udp\& b);}@
...
@\removed{ \} // namespace experimental}@
  ...
  template<> struct is_error_condition_enum<experimental::net::@\namespacever@::ip::resolver_errc>
    : public true_type {};

  // \ref{internet.hash}, hash support
  template<class T> struct hash;
  template<> struct hash<experimental::net::@\namespacever@::ip::address>;
  template<> struct hash<experimental::net::@\namespacever@::ip::address_v4>;
  template<> struct hash<experimental::net::@\namespacever@::ip::address_v6>;
...
\indextext{requirements!\idxnewoldconcept{InternetProtocol}}%
\rSec2[internet.reqmts.protocol]{Internet protocol requirements}

\pnum
A type \tcode{X} meets the \tmpdefnnewoldconcept{InternetProtocol} requirements if it \changed{satisfies}{meets} the requirements of \tmpnewoldconcept{AcceptableProtocol} (\ref{socket.reqmts.acceptableprotocol}), as well as the additional requirements listed below.

\pnum
In the table below,
\tcode{a} and \tcode{b} denote \removed{(possibly const)} values of type \added{(possibly const)} \tcode{X}.

\begin{libreqtab3}
{\tmpnewoldconcept{InternetProtocol} requirements}
...
\indextext{requirements!\idxnewoldconcept{MulticastGroupSocketOption}}%
\rSec2[internet.reqmts.opt.mcast]{Multicast group socket options}

\pnum
A type \tcode{X} meets the \tmpdefnnewoldconcept{MulticastGroupSocketOption} requirements if it \changed{satisfies}{meets} the requirements of \tmpoldconcept{Destructible} (\CppXref{destructible}), \tmpoldconcept{CopyConstructible} (\CppXref{copyconstructible}), \tmpoldconcept{CopyAssignable} (\CppXref{copyassignable}), and \tmpnewoldconcept{SettableSocketOption}~(\ref{socket.reqmts.settablesocketoption}), as well as the additional requirements listed below.

\pnum
In the table below,
\tcode{a} denotes a \removed{(possibly const)} value of type \added{(possibly const)} \tcode{address},
\tcode{b} and \tcode{c} denote (possibly const) values of type \tcode{address_v4},
\tcode{d} denotes a \removed{(possibly const)} value of type \added{(possibly const)} \tcode{address_v6},
\tcode{e} denotes a \removed{(possibly const)} value of type \added{(possibly const)} \tcode{unsigned int},
and \tcode{u} denotes an identifier.

\begin{libreqtab3}
{\tmpnewoldconcept{MulticastGroupSocketOption} requirements}
...
\pnum
In this document, types that \changed{satisfy}{meet} the \tmpnewoldconcept{MulticastGroupSocketOption} requirements are defined as follows.
...
namespace ip {
  ...
  @\removed{constexpr bool operator!=(const address\& a, const address\& b) noexcept;}@
  @\removed{constexpr bool operator< (const address\& a, const address\& b) noexcept;}@
  @\removed{constexpr bool operator> (const address\& a, const address\& b) noexcept;}@
  @\removed{constexpr bool operator<=(const address\& a, const address\& b) noexcept;}@
  @\removed{constexpr bool operator>=(const address\& a, const address\& b) noexcept;}@
...
\indexlibrary{\idxcode{address}}%
\pnum
\added{Class} \tcode{address} \changed{satisfies}{meets} the requirements for \tmpoldconcept{Destructible} (\CppXref{destructible}), \tmpoldconcept{CopyConstructible} (\CppXref{copyconstructible}), and \tmpoldconcept{CopyAssignable} (\CppXref{copyassignable}).
...
\pnum
\throws \tcode{bad_address_cast} if \tcode{is_v4() == false}.
\end{itemdescr}
...
\pnum
\throws \tcode{bad_address_cast} if \tcode{is_v6() == false}.
\end{itemdescr}
...
\indexlibrarymember{operator<=>}{address}%
\begin{itemdecl}
constexpr partial_ordering operator<=>(const address& a, const address& b) noexcept;
\end{itemdecl}
...
\begin{itemize}
\item
 if \tcode{a.is_v4() != b.is_v4()}, the result of \tcode{b.is_v4() <=> a.is_v4()};
\item
 otherwise, if \tcode{a.is_v4()} is \tcode{true}, the result of \tcode{a.v4_ <=> b.v4_};
\item
 otherwise, the result of \tcode{a.v6_ <=> b.v6_}.
\end{itemize}

\ednote{Restored specified ordering between v4 and v6 addresses}
...
namespace ip {
  ...
  @\removed{constexpr bool operator!=(const address_v4\& a, const address_v4\& b) noexcept;}@
  @\removed{constexpr bool operator< (const address_v4\& a, const address_v4\& b) noexcept;}@
  @\removed{constexpr bool operator> (const address_v4\& a, const address_v4\& b) noexcept;}@
  @\removed{constexpr bool operator<=(const address_v4\& a, const address_v4\& b) noexcept;}@
  @\removed{constexpr bool operator>=(const address_v4\& a, const address_v4\& b) noexcept;}@
  @\added{constexpr strong_ordering operator<=>(const address_v4\& a, const address_v4\& b) noexcept;}@
...
\pnum
\tcode{address_v4} \changed{satisfies}{meets} the requirements for \tmpoldconcept{Destructible} (\CppXref{destructible}), \tmpoldconcept{CopyConstructible} (\CppXref{copyconstructible}), and \tmpoldconcept{CopyAssignable} (\CppXref{copyassignable}).
...
\begin{itemdescr}
\pnum
\changed{\remarks}{\throws} \tcode{out_of_range} if any element of \tcode{bytes} is not in the range \tcode{[0, 0xFF]}. \begin{note} For implementations where \tcode{numeric_limits<unsigned char>::max() == 0xFF}, no out-of-range detection is needed. \end{note}
...
\begin{itemdescr}
\pnum
\changed{\remarks}{\throws} \tcode{out_of_range} if \tcode{val} is not in the range \tcode{[0, 0xFFFFFFFF]}. \begin{note} For implementations where \tcode{numeric_limits<address_v4::uint_type>::max() == 0xFFFFFFFF}, no out-of-range detection is needed. \end{note}
...
\indexlibrarymember{operator<=>}{address_v4}%
\begin{itemdecl}
constexpr strong_ordering operator<=>(const address_v4& a, const address_v4& b) noexcept;
\end{itemdecl}
...
\pnum
\changed{\remarks}{\throws} \tcode{bad_address_cast} if \tcode{a.is_v4_mapped()} is \tcode{false}.
\end{itemdescr}
...
namespace ip {
  ...
  @\removed{constexpr bool operator!=(const address_v6\& a, const address_v6\& b) noexcept;}@
  @\removed{constexpr bool operator< (const address_v6\& a, const address_v6\& b) noexcept;}@
  @\removed{constexpr bool operator> (const address_v6\& a, const address_v6\& b) noexcept;}@
  @\removed{constexpr bool operator<=(const address_v6\& a, const address_v6\& b) noexcept;}@
  @\removed{constexpr bool operator>=(const address_v6\& a, const address_v6\& b) noexcept;}@
  @\added{constexpr strong_ordering operator<=>(const address_v6\& a, const address_v6\& b) noexcept;}@
...
\pnum
\tcode{address_v6} \changed{satisfies}{meets} the requirements for \tmpoldconcept{Destructible} (\CppXref{destructible}), \tmpoldconcept{CopyConstructible} (\CppXref{copyconstructible}), and \tmpoldconcept{CopyAssignable} (\CppXref{copyassignable}).
...
\begin{itemdescr}
\pnum
\changed{\remarks}{\throws} \tcode{out_of_range} if any element of \tcode{bytes} is not in the range \crange{0}{0xFF}. \begin{note} For implementations where \tcode{numeric_limits<unsigned char>::max() == 0xFF}, no out-of-range detection is needed. \end{note}
...
\indexlibrarymember{operator<=>}{address_v6}%
\begin{itemdecl}
constexpr strong_ordering operator<=>(const address_v6& a, const address_v6& b) noexcept;
\end{itemdecl}
...
\begin{itemdescr}
\pnum
\removed{\requires the template specializations shall meet the requirements of class template \tcode{hash} (\CppXref{unord.hash}).}

\added{The template specializations are enabled (\CppXref{unord.hash}).}
\end{itemdescr}
...
\pnum
Specializations of \tcode{basic_address_iterator} \changed{satisfy}{meet} the requirements for input iterators (\CppXref{input.iterators}).
...
\pnum
Specializations of \tcode{basic_address_range} \changed{satisfy}{meet} the requirements for \tmpoldconcept{Destructible} (\CppXref{destructible}), \tmpoldconcept{CopyConstructible} (\CppXref{copyconstructible}), and \tmpoldconcept{CopyAssignable} (\CppXref{copyassignable}).
...
\added{
\constraints \tcode{is_same_v<\placeholder{Address}, address_v4>} is \tcode{true}.
}

\ednote{Adding \tcode{requires same_as<\placeholder{Address}, address_v4>} would be nicer than using \constraints here.}
...
namespace ip {
  ...
  @\removed{constexpr bool operator!=(const network_v4\& a, const network_v4\& b) noexcept;}@
...
\pnum
\tcode{network_v4} \changed{satisfies}{meets} the requirements for \tmpoldconcept{Destructible} (\CppXref{destructible}), \tmpoldconcept{CopyConstructible} (\CppXref{copyconstructible}), and \tmpoldconcept{CopyAssignable} (\CppXref{copyassignable}).
...
\pnum
\changed{\remarks}{\throws} \tcode{out_of_range} if \tcode{prefix_len < 0} or \tcode{prefix_len > 32}.
\end{itemdescr}
...
\pnum
\changed{\remarks}{\throws} \tcode{invalid_argument} if \tcode{mask} contains non-contiguous non-zero bits, or if the most significant bit is zero and any other bits are non-zero.
\end{itemdescr}
...
namespace ip {
  ...
  @\removed{constexpr bool operator!=(const network_v6\& a, const network_v6\& b) noexcept;}@
...
\pnum
\tcode{network_v6} \changed{satisfies}{meets} the requirements for \tmpoldconcept{Destructible} (\CppXref{destructible}), \tmpoldconcept{CopyConstructible} (\CppXref{copyconstructible}), and \tmpoldconcept{CopyAssignable} (\CppXref{copyassignable}).
...
\pnum
\changed{\remarks}{\throws} \tcode{out_of_range} if \tcode{prefix_len < 0} or \tcode{prefix_len > 128}.
\end{itemdescr}
...
namespace ip {
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{constexpr bool operator!=(const basic_endpoint<InternetProtocol>\& a,}@
                              @\removed{const basic_endpoint<InternetProtocol>\& b) noexcept;}@
  @\removed{template<class InternetProtocol>}@
    @\removed{constexpr bool operator< (const basic_endpoint<InternetProtocol>\& a,}@
                              @\removed{const basic_endpoint<InternetProtocol>\& b) noexcept;}@
  @\removed{template<class InternetProtocol>}@
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{constexpr bool operator>=(const basic_endpoint<InternetProtocol>\& a,}@
                              @\removed{const basic_endpoint<InternetProtocol>\& b) noexcept;}@
  @\added{template<class InternetProtocol>}@
    @\added{constexpr partial_ordering operator<=>(const basic_endpoint<InternetProtocol>\& a,}@
                                           @\added{const basic_endpoint<InternetProtocol>\& b) noexcept;}@
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} \tcode{proto == protocol_type::v4() || proto == protocol_type::v6()}.
...
\begin{itemdecl}
template<class InternetProtocol>
  constexpr partial_ordering operator<=>(const basic_endpoint<InternetProtocol>& a,
                                         const basic_endpoint<InternetProtocol>& b) noexcept;
\end{itemdecl}
...
\begin{itemdescr}
\pnum
\changed{\remarks}{\throws} \tcode{length_error} if either of the following conditions is \tcode{true}:
\begin{itemize}
...
namespace ip {
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{bool operator!=(const basic_resolver_entry<InternetProtocol>\& a,}@
                    @\removed{const basic_resolver_entry<InternetProtocol>\& b);}@
...
\pnum
\removed{\remarks Ill-formed unless \tcode{allocator_traits<Allocator>::value_type} is \tcode{char}.}

\added{\mandates \tcode{is_same_v<allocator_traits<Allocator>::value_type, char>} is \tcode{true}.}
\end{itemdescr}
...
namespace ip {
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{bool operator!=(const basic_resolver_results<InternetProtocol>\& a,}@
                    @\removed{const basic_resolver_results<InternetProtocol>\& b);}@
...
\pnum
The class template \tcode{basic_resolver_results} \changed{satisfies}{meets} the requirements of a sequence container (\CppXref{sequence.reqmts}), except that only the operations defined for const-qualified sequence containers are supported. The class template \tcode{basic_resolver_results} supports forward iterators.
...
\pnum
\removed{\remarks In the last two overloads, ill-formed unless \tcode{allocator_traits<Allocator>::value_type} is \tcode{char}.}

\added{\mandates For the overloads with an \tcode{Allocator}, \tcode{is_same_v<allocator_traits<Allocator>::value_type, char>} is \tcode{true}.}
\end{itemdescr}
...
namespace ip {
  ...
  @\removed{constexpr bool operator!=(const tcp\& a, const tcp\& b) noexcept;}@
...
namespace ip {
  ...
  @\removed{constexpr bool operator!=(const udp\& a, const udp\& b) noexcept;}@
...
\changed{Satisfies}{Meets} the \tmpnewoldconcept{MulticastGroupSocketOption} (\ref{internet.reqmts.opt.mcast}) type requirements. Requests that the socket join the specified multicast group.  \\ \rowsep
...
\tcode{ipv6_mreq} if \tcode{F == AF_INET6}, otherwise \tcode{ip_mreq}  &
\changed{Satisfies}{Meets} the \tmpnewoldconcept{MulticastGroupSocketOption} (\ref{internet.reqmts.opt.mcast}) type requirements. Requests that the socket leave the specified multicast group.  \\ \rowsep
...
\tcode{int}  &
\changed{Satisfies}{Meets} the \tmpnewoldconcept{BooleanSocketOption} (\ref{socket.reqmts.opt.bool}) type requirements. Determines whether multicast datagrams are delivered back to the local application.  \\
