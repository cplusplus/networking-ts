...
\tcode{TCP_NODELAY}  &
\tcode{int}  &
Satisfies the \tcode{BooleanSocket\-Option}~(\ref{socket.reqmts.opt.bool}) type requirements. Determines whether a TCP socket will avoid coalescing of small segments. \enternote That is, setting this option disables the Nagle algorithm. \exitnote  \\ \rowsep
