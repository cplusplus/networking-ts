...
namespace ip {
  ...
  @\removed{constexpr bool operator<=(const address\&, const address\&) noexcept;}@
  @\removed{constexpr bool operator>=(const address\&, const address\&) noexcept;}@
  @\added{constexpr strong_ordering operator<=>(const address\&, const address\&) noexcept;}@
...
@\added{namespace ip \{}@
  ...
  @\added{template<class InternetProtocol>}@
    @\added{strong_ordering operator<=>(const basic_endpoint<InternetProtocol>\&,}@
...
\indexlibrarymember{operator<=>}{address}%
\begin{itemdecl}
constexpr strong_ordering operator<=>(const address& a, const address& b) noexcept;
\end{itemdecl}
...
namespace ip {
  ...
  @\removed{template<class InternetProtocol>}@
    @\removed{constexpr bool operator>=(const basic_endpoint<InternetProtocol>\& a,}@
                              @\removed{const basic_endpoint<InternetProtocol>\& b) noexcept;}@
  @\added{template<class InternetProtocol>}@
    @\added{constexpr strong_ordering operator<=>(const basic_endpoint<InternetProtocol>\& a,}@
...
\begin{itemdecl}
template<class InternetProtocol>
  constexpr strong_ordering operator<=>(const basic_endpoint<InternetProtocol>& a,
                                        const basic_endpoint<InternetProtocol>& b) noexcept;
\end{itemdecl}
