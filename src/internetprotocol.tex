...
\begin{itemdescr}
\pnum
\returns If \tcode{is_host()} is \tcode{true}, an \tcode{address_v4_range} object representing the single address \tcode{this->addr\-ess()}. Otherwise, an \tcode{address_v4_range} object representing the range of unique host IP addresses in the network.
