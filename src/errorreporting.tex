...
\pnum
In this document, when a type requirement is specified as a call to a function or member function having the prefix \tcode{async_}, then the function satisfies the error reporting requirements described above.
