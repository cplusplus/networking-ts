...
\changed{Error conditions}{\errors{}},
this lists conditions where the operation may fail.
The conditions are listed, together with a suitable explanation, as \tcode{enum class} constants.
